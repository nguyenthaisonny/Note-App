...
export const resolvers = {
  ...
  Mutation: {
    ...
    deleteNote: async (parent, args) => {
      console.log('delenote', args);
 
      const deleteNote = await NoteModel.deleteOne({_id: args.noteId})
      const reloaderNotes = await NoteModel.find({folderId: args.folderId}).sort({
        updatedAt: 'desc',
      });
      console.log('reloader', reloaderNotes);
      return reloaderNotes
    },
